...
public class ConsultaAutomovil extends javax.swing.JFrame {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (tablaAutos.getRowCount() > 0) {
            ...
            if (tablaAutos.getSelectedRow() != -1) {
                ...
                mostrarMensaje("Auto borrado correctamente", "Info", "Borrado de auto exitoso.");
                cargarTabla();
            ...
            mostrarMensaje("La tabla está vacpia, no se puede eliminar.", "Error", "Error al eliminar.");
        }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (tablaAutos.getRowCount() > 0) {
            ...
            if (tablaAutos.getSelectedRow() != -1) {
                ...
                int idAuto = Integer.parseInt(String.valueOf(tablaAutos.getValueAt(tablaAutos.getSelectedRow(), 0)));
                System.out.println("ID del auto seleccionado para modificar: " + idAuto);
            ...
            mostrarMensaje("La tabla está vacpia, no se puede modificar.", "Error", "Error al modificar.");
        }
    ...
    private void cargarTabla() {
        ...
        DefaultTableModel modeloTabla = new DefaultTableModel() {
            ...
            @Override
            public boolean isCellEditalbe(int row, int column) {
                return false;
            }
